...
<form action="<?php echo base_url();?>index.php/dashboard/proses_hapus_komentar/<?php echo $row->id_komentar; ?>" method="post">
 ...
 <div class="form-group">
            <label>Apakah Anda Yakin Menghapus Komentar...???</label>
            <p></p>
            <label>"<?= $row->isi_komentar;?>"</label>
          </div>
...
<form action="<?php echo base_url('index.php/dashboard/edit_komentar')?>" method="post">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Status Keterlihatan</label>
            <select name="tampil" class="form-control">
              <option value="<?=$row->tampil;?>"><?=$row->tampil;?></option>
           ...
           <div class="form-group">
            ...
            <textarea class="form-control ckeditor" name="isi_komentar" cols="30" rows="3" value="#"><?=$row->isi_komentar;?></textarea>
            <div><?php echo form_error('isi_komentar'); ?></div>
          </div>
