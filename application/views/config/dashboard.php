...
<div class="wrapper">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo base_url();?>index.php/dashboard/tambah_berita">
...
<form action="<?php echo base_url();?>index.php/dashboard/proses_hapus_berita/<?php echo $row->id_berita; ?>" method="post">
 ...
 <div class="form-group">
            <label>Apakah Anda Yakin Menghapus Berita...???</label>
            <br>
        ...
        <div class="modal-body">
         ...
         <div class="form-group">
           ...
           <div class="form-group">
            ...
            <textarea class="form-control ckeditor" name="isi" cols="30" rows="3" value="<?=$row->isi;?>"><?=$row->isi;?></textarea>
            <div><?php echo form_error('isi'); ?></div>
          </div>
          <div class="form-group">
           
          <label>Link Gambar</label>
          <input type="text" name="image" autocomplete="off" value="<?=$row->image;?>" required placeholder="Masukkan Modal" class="form-control" cols="30" rows="3">
          </div>
